...
const faqs: FaqEntry[] = [
  ...
  {
    question: "外部CTOと顧問・アドバイザーの違いは何ですか？",
    answer:
      "一般的な顧問・アドバイザーは「壁打ち時間」の提供が中心です。レミナス外部CTOは、貴社内にCTOがいるかのように、意思決定から実行までチームに入り込んで推進します。ミーティングやSlackでやりとりをしながら週単位など短いスパンでサイクルを回します。",
  },
  {
  ...
  },
  {
    question: "開発会社ですか？",
    answer:
      "開発会社ではありません。Reminusの外部CTOは内製支援を重視しており、成果を出すことはもちろん、ノウハウをお客様社内に溜めることも大事にしております。ご要望次第では、外部CTOとは別途、開発領域を担う場合もありますが、あくまで貴社チームの一員として事業に向き合います。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "はい、一部コードを書くことがございます。当社外部CTOは少ない稼働で最大の成果を出す価格設計となっております。立ち上げの際には、外部CTOが採用や人員調達も支援しながら、手も動かす方式です。ARR1億以上などすでに規模がある場合には、技術判断や設計に注力することが多いです。",
  },
  {
