        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          >
            ...
            <div className="space-y-6 text-neutral-300 leading-relaxed">
              <p>
              Reminusは、「トップレベルのSaaSエンジニアリングの洞察を、事業に実装する」という理念のもと、貴社のエンジニアリングのレベルを底上げする包括的なエンジニアリング機能を提供しています。単なる「できることの羅列」ではなく、あらゆるエンジニアリング組織に必要な横断的機能を厳選しています。各領域は、技術誌への寄稿やイベント登壇、技術記事執筆が可能なレベルにあり、貴社に不足しているエッセンスを補うことに特化しています。
              </p>
            </div>

            <div className="space-y-6 text-neutral-300 leading-relaxed">
              <p>
              1つの領域はもちろん、複数の領域にまたがるご依頼にも、ごく少人数で柔軟に対応します。幅広さと深さを兼ね備えた個々の能力により、貴社メンバーとのスムーズな連携を実現しつつ、人数増加による無駄なコミュニケーションを抑制。コミュニケーションの質を高めながら量を最適化することで、意思決定と実行のスピードを大幅に加速させることも、私たちの強みです。</p>            </div>

            <div className="space-y-6 text-neutral-300 leading-relaxed">
              <p>
              どのようなフェーズの企業様でも、まずはお気軽にご相談ください。
              創業期であれば、コア人材の不在を補って全方位的にエンジニアリングを強化し、事業の成長を加速させます。成長中のスタートアップや成熟企業には優秀な人材が揃っているかもしれませんが、私たちは横断的なエンジニアリング機能に特化しているため、1つや2つ遅れている部分を押し上げるお手伝いができるかもしれません。
