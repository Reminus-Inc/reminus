        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          >
            ...
            <div className="space-y-6 text-base md:text-lg text-neutral-300 leading-relaxed">
              <p>
                それに加えて、Reminusのサービスラインナップは単なる「できることの羅列」ではありません。私たちは「洗練されたSaaSエンジニアリングを事業に実装する」という理念のもと、あらゆるエンジニアリング組織に不可欠な横断的機能に特化して提供することで、深さと幅広さを両立しています。各領域は、技術誌への寄稿やイベント登壇、技術記事執筆が可能な高度な専門性と支援実績を有するものに厳選しており、貴社の事業に不足しているエッセンスを補い、エンジニアリングの質を引き上げることに特化しています。
              </p>
            </div>
            <div className="space-y-6 text-base md:text-lg text-neutral-300 leading-relaxed">
              <p>
