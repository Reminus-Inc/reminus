    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          {/* 技術戦略 */}
          <div className="mb-8 bg-emerald-50 lg:bg-gradient-to-r lg:from-emerald-50 lg:to-white rounded-xl overflow-hidden shadow-sm">
          ...
          {/* 組織開発 */}
          <div className="mb-8 bg-emerald-50 md:bg-gradient-to-r md:from-emerald-50 md:to-white rounded-xl overflow-hidden shadow-sm">
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/3 p-8 flex flex-col items-center justify-center text-center">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mb-4">
