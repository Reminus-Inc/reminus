...
const caseStudies = [
  {
    title: "経営管理SaaSで創業後、MVP構築でシード調達成功",
    industry: "経営管理SaaS",
    companySize: "シード",
    description: [
      "経営陣がビジネスプロフェッショナル中心で経営に技術視点を持ちづらい課題があった。",
      "競争力の源泉となる事業計画機能の設計レビュー、採用プロセスの設計、JDの設計、組織設計と開発プロセス設計、ロードマップ策定を支援。",
      "MVPによるトラクション獲得でシードでの資金調達達成。ロードマップの着実な進行により有料ユーザーの早期獲得達成。エンジニア6名まで組織拡大。",
    ],
    services: ["CTOパートナー", "技術顧問"],
  },
  {
