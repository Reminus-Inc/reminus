...
const MemberCard = ({ label, title, career, strengths }: MemberCardData) => {
  return (
    <div className="mx-auto flex h-full w-full flex-col rounded-lg border border-solid border-gray-300 bg-gray-50/50 p-4 pb-5 shadow-sm sm:h-auto sm:w-auto sm:max-w-[326px] sm:pb-6">
      <div>
