  ...
  return (
    <section className={cn("content-auto font-sans", className)}>
      ...
      <div className="bg-emerald-500">
        ...
        <div className="mx-auto w-[82%] max-w-[1200px] py-10 text-center sm:py-16">
          <p className="text-2xl font-bold !leading-[1.6] tracking-wider text-white sm:text-3xl md:text-4xl lg:text-[40px]">
            そのお悩み、
