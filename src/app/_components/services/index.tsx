...
const services: Service[] = [
  ...
  
  {
    title: "フロントエンドアーキテクト",
    icon: Zap,
    summary: "売上や顧客満足度とコスト効率につながり、ブランド価値を高める最先端のUI/UX",
    description:
  ...
  },
  {
    ...
    icon: BarChart,
    summary: "障害検知力・障害対応力・システム信頼性を強化し、持続可能なシステム運用を支える",
    description:
  ...
  },
  {
    ...
    points: [
      ...
      },
      {
        ...
        description: "将来の事業展開に備えた構成変更や抜本的な設計課題の改善には大きな工数とリードタイムが必要です。理想的なアーキテクチャを目指し、事業計画に沿った長期的な戦略と実現のロードマップを策定します。"
      },
      {
        title: "パフォーマンス改善でコスト効率も向上",
        description:
          "パフォーマンス改善はお金がかかると思っていませんか？実は、優れたパフォーマンス改善はシステムの効率を大幅に向上し、むしろコストを削減します。売上向上とコスト効率の二兎を両立し、事業のスケールにも耐えられるようにします。",
      },
    ],
  },
  {
    ...
    },
    {
      title: "PoC・受託開発",
      icon: Handshake,
      summary: "SaaSプロダクトレベルの受託開発",
      description: "全ての開発をSaaSプロダクト開発にバックボーンを持つ精鋭で対応。運用と事業成長を見据えたシステム開発を行います。",
      points: [
        {
          title: "少人数で幅広い技術分野に対応",
          description:
            "SaaSプロダクト開発に精通した少数の専門家が、フロントエンドから全体アーキテクチャの設計と実装、インフラ構築や運用まで幅広く対応。これにより、高速かつ精度の高いPoCやシステム開発を実現します。",
        },
        {
          title: "高品質で成長を支えるシステム",
          description:
            "SaaS開発の経験に裏打ちされた開発により、UX設計や柔軟性のある設計、運用設計までを高いレベルで実現。納品後の運用や事業成長まで見据えた持続可能なシステムを構築します。",
        },
        {
          title: "柔軟で円滑なプロジェクト推進",
          description:
            "SaaSプロダクトとSIerの経験を兼ね備えたエンジニアが在籍。高い技術力に加え、事業の専門家やクライアントとの対話力により、柔軟かつ正確な要求把握を実現し、スムーズなプロジェクト進行をサポートします。",
        },
      ],
    }
];
