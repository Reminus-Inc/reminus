...
const faqs: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "一般的な顧問・アドバイザーは「壁打ち時間」の提供が中心です。レミナスCTO代行は、貴社内にCTOがいるかのように、意思決定から実行までチームに入り込んで推進します。ミーティングやSlackでやりとりをしながら週単位など短いスパンでサイクルを回します。",
  },
  {
    question: "どんなフェーズや規模の企業が対象ですか？",
    answer:
      "シード〜シリーズBのスタートアップや、オーナー企業様、上場企業様の新規事業などにご利用いただいています。CTO不在の創業期、内製化への転換、外注管理、正社員CTO採用を控えた繋ぎ期間など、状況に応じて最適な関わり方をご提案します。",
  },
  {
    question: "開発会社ですか？",
    answer:
      "開発会社ではありません。当社レミナスは内製支援を重視しており、成果を出すことはもちろん、ノウハウをお客様社内に溜めることも大事にしております。ご要望次第で開発領域を担う場合もありますが、あくまで貴社チームの一員として事業に向き合います。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "稼働量と支援範囲に応じた月額の料金体系で、貴社の課題に合わせてご提案いたします。2ヶ月のトライアル契約からご利用いただけるため、成果を確かめたうえで半年の本契約に移行が可能です。正社員CTOの採用と比べて、固定費やミスマッチのリスクを抑えてご利用いただけます。",
  },
  {
