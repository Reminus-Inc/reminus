...
const RESULTS = [
  ...
  "開発をプロセスとして形にしたことで進捗や問題が定量的に見え、実行が安定して改善を回す下地を整えた",
];
    ...
    qa: [
      {
        ...
        a: [
          ...
          "今までは「これぐらいできるだろう」でやってみたらできたりできなかったり、ボラティリティがめちゃめちゃ大きかった。それが「これぐらいに収まる」「これにはもう少しリソースがいる」と見えたことで、ここで人を増やそう、という判断が合理的に下せる。",
