            ...
            <div className="mt-5 space-y-8">
              <div className="max-w-none text-left">
                <p className="text-sm !leading-[1.9] tracking-wide text-gray-900 md:text-base">
                  30億円調達の医療プロダクト・株式会社ヘンリーでエンジニアとして開発を牽引後、営業支援プロダクト・株式会社immedioのCTOに就任。社外CTO・技術顧問として6社を支援するなど、累計20社に携わるなかで、戦略も実行も情熱も揃うのに技術で事業が停滞する状況を何度も目にする。魅力的な事業の成長を技術で支えられるよう、2025年にReminusを創業。
                </p>
              </div>
