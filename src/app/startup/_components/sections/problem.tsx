  ...
  return (
    <section className={cn("content-auto font-sans", className)}>
      <div className="mx-auto w-[88%] max-w-[1200px] pb-20 pt-24 sm:pb-28 sm:pt-32">
        ...
        <div className="mt-10 flex justify-center sm:mt-14">
          <div className="relative flex gap-6 sm:gap-10 md:gap-16 lg:block">
            ...
            {/* 創業期 〜 レイター */}
            <div className="-my-3 flex flex-col items-center gap-2 sm:gap-3 lg:absolute lg:right-0 lg:top-1/2 lg:my-0 lg:-translate-y-1/2 lg:translate-x-full lg:pl-16">
      ...
      <div className="bg-emerald-500">
        ...
        <div className="mx-auto w-[96%] max-w-[1200px] pb-11 pt-8 text-center sm:pb-12 sm:pt-10 lg:pb-16 lg:pt-11">
          <p className="text-md font-bold !leading-[1.7] tracking-wider text-white sm:text-2xl md:text-3xl">
            レミナスCTO代行は、技術／採用／開発体制に不安を抱えるスタートアップに、
            <br />
            経営直下で伴走するCTO代行サービスです。
          </p>
        </div>
      </div>
    </section>
