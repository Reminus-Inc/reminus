...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn("min-w-0 shrink-0 grow-0 basis-[100%]", className)}
      {...props}
    />
  );
});
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute -left-8 top-1/2 h-8 w-8 -translate-y-1/2 rounded-full",
        className
      )}
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "absolute -right-8 top-1/2 h-8 w-8 -translate-y-1/2 rounded-full",
        className
      )}
